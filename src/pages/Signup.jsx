...
export default function Signup() {
    ...
    const handleSignup = async (e) => {
        ...
        try {
            const result = await signUpNewUser(emailRef.current.value, passwordRef.current.value)
    ...
    return (
        <Container className="mb-auto mt-auto">
            ...
            <div className="p-4 mb-2 text-left">
                Already have an account? <Link to="/BudgetTracker/Login">Log In</Link>
            </div>
            <Form className="shadow p-4 bg-white rounded" onSubmit={handleSignup}>
